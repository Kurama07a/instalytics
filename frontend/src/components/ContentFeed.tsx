            ...
            {Array.from({ length: 6 }).map((_, i) => (
              <Grid item xs={12} sm={6} md={4} key={i}>
                <Card className="glass-card" sx={{ 
                  ...
                  <Box sx={{ p: 2 }}>
                    <Box sx={{ height: 16, bgcolor: '#333', borderRadius: 1, mb: 1 }} />
                    <Box sx={{ height: 12, bgcolor: '#333', borderRadius: 1, mb: 1, width: '80%' }} />
                    <Box sx={{ display: 'flex', gap: 1 }}>
                      <Box sx={{ height: 12, bgcolor: '#333', borderRadius: 1, width: 40 }} />
                      <Box sx={{ height: 12, bgcolor: '#333', borderRadius: 1, width: 40 }} />
                      <Box sx={{ height: 12, bgcolor: '#333', borderRadius: 1, width: 40 }} />
                    </Box>
                  </Box>
